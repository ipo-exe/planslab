...
def hydroparams(fhydroparam):
    ...
    #
    hydroparam_obj = open_df(
        s_filepath=fhydroparam, s_sep=";", s_mandatory_fields="Set & Min & Max"
    )
    #
...
# deprecated
def dataframe_prepro(
    dataframe, strfields="Field1,Field2", strf=True, date=False, datefield="Date"
):
    """
